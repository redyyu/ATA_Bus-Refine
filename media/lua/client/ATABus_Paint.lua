    ...
    if graffitiType then 
        ...
        if (vehicle:getSkinIndex()%2) == 0 then
            ...
            if vehicle and paintBrush and paintCan then
                ...
                writeOpt.toolTip:setName(getText("ContextMenu_Vehicle_EGNH"))
                local desc_write = ""
                if paintBrush then
            ...
            cleanOpt = subMenu:addOptionOnTop(getText("ContextMenu_Vehicle_CLEAN_EGNH"),
            ...
            if vehicle and sponge and bleach then
                ...
                cleanOpt.toolTip:setName(getText("ContextMenu_Vehicle_CLEAN_EGNH"))
                local desc_clean = ""
                if sponge then
